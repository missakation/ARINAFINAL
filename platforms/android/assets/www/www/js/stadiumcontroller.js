...
angular.module('football.controllers')
    .controller('stadiumcontroller', function ($scope, LoginStore, $http, $ionicPopover, $interval, $ionicHistory, ReservationFact, $ionicPopup, $ionicLoading, $timeout, $state, $cordovaDatePicker, pickerView, SMSService, $ionicFilterBar) {
    ...
    .controller('stadiumdetailscontroller', function ($scope, LoginStore, pickerView, $stateParams, $ionicPopover, ReservationFact, $ionicPopup, $ionicLoading, $timeout, $state, $cordovaDatePicker, SMSService) {
        ...
        $scope.LoadPage = function () {
            try {
                ...
                ReservationFact.GetStadiumsByID($scope.CurrentStadium.stadiumkey, function (leagues) {
                    ...
                    var uluru = { lat: $scope.stadiums.cordovalatitude, lng: $scope.stadiums.cordovalongitude };
